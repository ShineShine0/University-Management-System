		...
		<div class="col-lg-12">
			<div class="row" style="border: 1px solid #00bcd4a3; margin-left: 1px; margin-right: 1px;margin-top:5px;">
				<form:form  class="form-horizontal" 
					action="${pageContext.request.contextPath}/admin/search_attendanceListBySemester.htm"
					...
					<label class="col-sm-4">From Month</label>
					<label class="col-sm-4">To Month</label>
					<label class="col-sm-4"></label>
					
					</div>
					<div class="col-sm-12">
					<div class="col-sm-4">
							<form:select path="fromMonth" class="form-control" >
						...
						<div class="col-sm-4">
							<form:select path="toMonth" class="form-control" >
									<form:option value="0">---Select Month---</form:option>
									<c:forEach items="${monthList}" var="item">
										<form:option value="${item.month}">${item.name}</form:option>
									</c:forEach>
...
<table  class="table table-primary" style="width: 100%;">
        <thead style="background-color: #a34bd0b8;">
            <tr>
            	...
            	<th>Roll_No </th>
                <th>Name </th>
                <c:forEach items="${attMonthList }" var="m">
                 <th>${m.name}</th>
                </c:forEach>
               <th>
               Total Attendance
