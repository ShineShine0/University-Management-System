			...
			<div class="col-sm-4">
				<div class="page-header float-left">
					<div class="page-title">
						<h1>AttendanceList By Subject</h1>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-12">
			<div class="row" style="border: 1px solid #00bcd4a3; margin-left: 1px; margin-right: 1px;margin-top:5px;">
				<form:form  class="form-horizontal" 
					action="${pageContext.request.contextPath}/admin/search_attendanceListBySubject.htm"
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
						<form:select path="classLevelId"  class="form-control" id="classLevelId">
...
<table  class="table table-primary" style="width: 100%;">
        <thead style="background-color: #a34bd0b8;">
            <tr>
            	...
            	<th>Roll_No </th>
                <th>Name </th>
                <c:forEach items="${attSubjectList }" var="m">
                 <th>${m.name}</th>
                </c:forEach>
               <th>
               Total Attendance
	...
	$(function(){
		$("#classLevelId").on("change" ,function(){
			...
			$.ajax({
		          ...
		          type: "GET",
		          url: contextUrl+"admin/ajax/get-section-list-for-subject",
		          dataType : 'json',
			 ...
			 $(function(){
				$("#majorId").on("change" ,function(){
					...
					var param1 =$("#sectionId").val();
					var param2 =$("#majorId").val();
					var param3 =$("#classLevelId").val();
					
					$.ajax({
				          contentType : 'application/json; charset=utf-8',
				          type: "GET",
				          url: contextUrl+"admin/ajax/get-subject-list-for-attendancesubject",
				          dataType : 'json',
				          data : {
			        	  		majorId:param2,
			        	  		classLevelId:param3},
