    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="col-lg-12">
			<div class="row"
				...
				action="${pageContext.request.contextPath}/teacher/saveLessonPlan.htm" commandName="lessonPlanDto" role="form" method="POST" enctype="multipart/form-data">
					...
					<div class="col-md-6" style="margin-top: 10px;">
					 File:
						...
						<div class="col-md-6" style="margin-top: 10px;">
						<img id="blah2" src="#" alt="no more than 10MB" /><br />
								<form:input type="file" onchange="readURL2(this);"
									path="textfile" required="true"/> 
						</div>
					<div class="col-md-6" style="margin-top: 10px;">
					 Image:
					</div>
						<div class="col-md-6" style="margin-top: 10px;">
						<img id="blah1" src="#" alt="no more than 10MB" /><br />
    ...
    <label class="form-check-label" for="term-and-condition">Check me out</label>
						...
						<div class="col-md-6"
							...
							<input type="submit" class="btn btn-success" value="Send" disabled="disabled" id="add-lesson"
								style="color: white; background-color: #a34bd0b8; width: 100px; border-radius: 5px;" />
						</div>
  						</form:form>
					</div>
			</div>
